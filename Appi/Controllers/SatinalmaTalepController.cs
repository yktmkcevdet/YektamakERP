...
namespace Appi.Controllers
{
    public class SatinalmaTalepController:Controller
    {
        ...
        //    return result;
        //}
        public IActionResult SatinalmaTalepOnay([FromBody] SatinalmaTalep restData)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState); // detaylı hataları döndürür
            }

            if (restData == null)
            {
                return BadRequest("Veri parse edilemedi");
            }
