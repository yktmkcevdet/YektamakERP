...
{
    public class DataAccesLayerMySqlLocal : IDataAccessLayer
    {
        /// <summary>
        ...
        {
            using (MySqlConnection conn = DataBaseJobsGeneral.MySqlConnectionYerel())
            {
                using (MySqlCommand cmd = new MySqlCommand(sqlCommandName, conn))
                {
        ...
        {
            MySqlConnection conn = DataBaseJobsGeneral.MySqlConnectionYerel();
