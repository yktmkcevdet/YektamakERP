...
namespace Models.DTO
{
    public class ProjeStokKartDTO:IEntity
    {
        ...
        [GridDisplay(Header = "Proje Kodu", Tip ="Liste", ListVisibleColumnName = "kod",ListName ="projes")]public int? projeId { get; set; }
        [GridDisplay(Header = "Kod")]public string projekod { get; set; }
        ...
        [GridDisplay(Header = "Ölçü Birim Id")]public int? stokKartolcuBirimId { get; set; }
