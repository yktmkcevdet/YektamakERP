...
namespace Models.DTO
{
    public class SatinalmaTeklifDetayDTO:IEntity
    {
        ...
        [GridDisplay(Header = "Stok Kart Id")]public int? satinalmaTalepDetaystokKartId { get; set; }
        [GridDisplay(Header = "Stok Kart Kod")]public string satinalmaTalepDetaystokKartkod { get; set; }
        [GridDisplay(Header = "Stok Kart Ad")]public string satinalmaTalepDetaystokKartad { get; set; }
