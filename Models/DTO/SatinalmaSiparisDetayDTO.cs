...
namespace Models.DTO
{
    public record SatinalmaSiparisDetayDTO:IEntity
    {
        ...
        [GridDisplay(Header = "miktar",readOnly =false)] public double? miktar { get; set; }
        [GridDisplay(Header = "Birim Fiyat",readOnly =false)] public double? birimFiyat { get; set; }
        [GridDisplay(Header = "Döviz Cinsi", Tip = "Liste", ListName = "dovizCinsiList", ListVisibleColumnName = "ad",readOnly = false)] public int? dovizCinsiId { get; set; }
