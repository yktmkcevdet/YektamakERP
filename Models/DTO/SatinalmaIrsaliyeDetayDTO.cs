...
namespace Models.DTO
{
    public class SatinalmaIrsaliyeDetayDTO:IEntity
    {
        ...
        [GridDisplay(Header = "Proje StokKart Id")] public int? satinalmaSiparisprojeStokKartId { get; set; }
        [GridDisplay(Header = "Stok Kodu")] public string satinalmaSiparisprojeStokKartstokKartkod { get; set; }
        [GridDisplay(Header = "Stok Adı")] public string satinalmaSiparisprojeStokKartstokKartad { get; set; }
