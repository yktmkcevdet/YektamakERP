...
namespace YektamakDesktop.Formlar.Satinalma
{
    public partial class SatinalmaTalepFormuDetay : Form, IForm
	{
		...
		private static SatinalmaTalepFormuDetay _satinalmaTalepFormuDetay;

        public static SatinalmaTalepFormuDetay satinalmaTalepFormuDetay 
		{ 
			get 
			{ 
			...
			set 
			{ 
				_satinalmaTalepFormuDetay = value; 
			} 
		}
		...
		private void CloseForm()
		{
			...
			_satinalmaTalepFormuDetay = null;
		}
		...
		private async void btnKaydet_Click(object sender, EventArgs e)
		{
			...
			foreach (DataControlTalepDetay dataControlTalepDetay in customDataGrid.dataSource)
			{
