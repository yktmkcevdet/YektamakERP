...
namespace YektamakDesktop.Formlar.Satinalma
{
    public partial class SatinalmaTalepKayitFormu : Form
    {
        ...
        public SatinalmaTalepKayitFormu(ICache cache, ISatinalmaTalepService satinalmaTalepService,IFileService fileService,
            IJsonConverter jsonConverter, IProjeService projeService, IAnaVeriService anaVeriService, IConvertHelper convertHelper, IMailService mailService)
        {
            _cache = cache;
        ...
        private async Task Binding()
        {
            ...
            {
                satinalmaTalepDetayList.Add(_convertHelper.ToDTO<SatinalmaTalepDetayDTO>(std));
            }
        ...
        private void CreateSatinalmaTalep()
        {
            ...
            foreach (var item in universalGrid1.binding.OfType<SatinalmaTalepDetayDTO>())
            {
                ...
                _satinalmaTalep.satinalmaTalepDetays.Add(_convertHelper.ToEntity<SatinalmaTalepDetay>(item));
            }
        }
        ...
        private async Task HandleSaveResult(string jsonResult)
        {
            ...
            else
            {
                ...
                _mailService.SendMailGraph(mail.To,mail.Cc, mail.Subject, mail.Body, mail.attachmentData);
            }
        }
        ...
        private void seçilenKayıtlarıBirleştirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            projeStokKart = _convertHelper.ToEntity<SatinalmaTalepDetay>(list[0]).projeStokKart;
